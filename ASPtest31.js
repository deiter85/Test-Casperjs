...
casper.test.begin('Comprobar pagina ASPgems - Test31 - Servicios-Rescue Projects', 7, function suite(test) {    
    ...
    casper.then(function() {
   	  	casper.click("a[href='/servicios/rescue-projects']"); //hacer click en recue projects
    });
  	casper.then(function() {		
  	   	test.assertUrlMatch('https://aspgems.com/servicios/rescue-projects', 'Direccion URL correcta'); //comprobar la direccion URL
    });
    casper.then(function() {
